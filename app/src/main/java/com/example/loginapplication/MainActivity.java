...
public class MainActivity extends AppCompatActivity {
    ...
    private CheckBox eRememberMe2;
    private ImageButton efacebookButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eRememberMe2 = findViewById(R.id.cbRememberMe2);
        efacebookButton = findViewById(R.id.buttonFacebook);

        efacebookButton.setImageResource(R.drawable.facebookbutton);
        ...
        if(sharedPreferences != null){
            ...
            if(sharedPreferences.getBoolean("RememberMeCheckbox", false)){
                ...
                eRememberMe2.setChecked(true);
            }
        }

        eRememberMe2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                sharedPreferencesEditor.putBoolean("RememberMeCheckbox", eRememberMe2.isChecked());
            ...
            public void onClick(View v) {
                ...
                if(inputName.isEmpty() || inputPassword.isEmpty())
                {
                    ...
                    if(!isValid){
                        ...
                        Intent intent = new Intent(MainActivity.this, AppHomePage.class);
